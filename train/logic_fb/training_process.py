...
from train.logic_fb.model_selection import cross_validation


def training_process(input_range: int, prediction_time: int, date_feature: pd.DataFrame,
                     n_splits: int, max_train_size: int, test_size, batch_size: int, learning_rate: float,
    ...
    y_true, y_pred = cross_validation(date_feature=date_feature_copy, input_range=input_range,
                                      ...
                                      max_train_size=max_train_size, loss=loss, batch_size=batch_size,
                                      learning_rate=learning_rate, model_type=model_type, dropout=dropout,
...
def training_process_opt(input_range: int, prediction_time: int, date_feature: pd.DataFrame,
                         n_splits: int, max_train_size: int, test_size, batch_size, learning_rate, model_type: str,
    ...
    y_true, y_pred = training_process(input_range=input_range, prediction_time=prediction_time,
                                      date_feature=date_feature, n_splits=n_splits,
