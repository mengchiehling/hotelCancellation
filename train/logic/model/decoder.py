...
def LSTM_decoder(state_h, lstm_units, dense_units, decoder_cat_dict, dropout: float=0, recurrent_dropout: float=0):

    inputs_layers, categorical_inputs = generate_categorical_embeddings(state_h, decoder_cat_dict)

    categorical_inputs.append(RepeatVector(7)(state_h))
