...
def build_decoder(state_h, state_c, dense_units, decoder_cat_dict, lstm_units_1: Optional[int]=None, dropout: float=0,
                  recurrent_dropout: float=0):
    ...
    y = LSTM(state_h.shape[1], activation='relu', return_sequences=True, dropout=dropout,
...
def build_model(n_inputs, n_features, decoder_cat_dict: Dict, encoder_lstm_units_0: int,
    ...
    decoder_inputs_layers, outputs = build_decoder(state_h, state_c, dense_units=decoder_dense_units,
